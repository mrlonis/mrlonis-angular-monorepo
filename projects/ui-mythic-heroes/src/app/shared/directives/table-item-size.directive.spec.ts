 ...
 *
 * @param {ComponentFixture<any>} fixture The Fixture
 */
 ...
 *
 * @param {CdkVirtualScrollViewport} viewport The viewport
 * @param {number | undefined} offset The offset
 */
...
/**
 *
 * @param {Node | Window} node The node or window
 * @param {string} type The type
 * @param {boolean} canBubble Can bubble
 ...
 * @param {string} type The type
 * @param {boolean} canBubble Can bubble
 * @param {boolean} cancelable Can cancel
 * @returns {Event} The event
 */
function createFakeEvent(type: string, canBubble: boolean = false, cancelable: boolean = true): Event {
  const event = new Event(type, { bubbles: canBubble, cancelable: cancelable });
